...
angular.module('App')
  .controller('MainCtrl', ['$scope', 'ModalService', 'ListService', '$rootScope', function ($scope, ModalService, ListService, $rootScope) {
    ...
    $scope.lists = [
      ...
      {title: 'Peru 7days', price: 1199, description: 'Seven-Day Inca Trail Trek to Machu Picchu Including Meals and Transfers with Valencia Travel Cusco', image: 'https://img.grouponcdn.com/deal/9Uz1Sb4ovkoi2cnZNh7V/Pg-960x576/v1/c700x420.jpg', subCategory: 'Travel', id:58},
      {title: 'Norlan Whiskey Glass', price: 48, description: 'sdjfkla sjdkfaljskdf', image: 'https://ksr-ugc.imgix.net/assets/004/772/694/848cf08a83fce100435d99e39c9ff15e_original.gif?v=1445901679&w=680&fit=max&q=92&s=18850806264b26798f51c1106453d6f8', subCategory: 'featured', id:59},
      {title: 'Tesla Model S', price: 124813, description: 'Tesla\'s advanced electric powertrain delivers exhilarating performance. Unlike a gasoline internal combustion engine with hundreds of moving parts, Tesla electric motors have only one moving piece: the rotor. As a result, Model S acceleration is instantaneous, silent and smooth. Step on the accelerator and in as little as 3.0 seconds Model S is traveling 100 km per hour, without hesitation, and without a drop of gasoline. Model S is an evolution in automobile engineering.', image: 'https://www.teslamotors.com/sites/default/files/images/homepage/home_hero_70.jpg', subCategory: 'Auto', id:60},
      {title: 'G-RO', price: 199, description: 'The world\'s best carry-on luggage- its patented "all-terrain" wheels change EVERYTHING!', image: 'http://static.highsnobiety.com/wp-content/uploads/2015/10/gro-revolutionary-luggage-04.jpg', subCategory: 'featured', id:61}
    ]
  }]);
